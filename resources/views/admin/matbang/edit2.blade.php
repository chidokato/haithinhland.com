	...
	<div class="row-fluid sortable ui-sortable">
		<div class="box span6" style="">
			<div class="box-header" data-original-title="">
				<h2><i class="halflings-icon white edit"></i><span class="break"></span>Mặt bằng tòa - {{$product->name}}</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal" action="admin/matbang/add/{{$product->id}}" method="POST" enctype="multipart/form-data">
		...
		<div class="box span6" style="">
			...
			<div class="box-content">
				<form class="form-horizontal" action="admin/matbang/edit2/{{$matbang->id}}/{{$product->id}}" method="POST" enctype="multipart/form-data">
				<input type="hidden" name="_token" value="{{csrf_token()}}" />
				  	<fieldset>
						...
						<div class="control-group span6">
							...
							<div>
							  	<select required name="mb_id" >
							  		@foreach($product->matbangtoa as $val)
							  		<option <?php if($val['id'] == $matbang['mb_id']){echo "selected";} ?> value="{!! $val['id'] !!}">{!! $val['name'] !!}</option>
							  		@endforeach
							  	</select>
							</div>
					  	</div>
						...
						<div class="control-group">
						  	<label></label>
						  	<div>
								<img required style="max-height: 150px;" src="{{$matbang->img}}">
						  	</div>
						</div>
						<div class="control-group">
						  	<label>Image</label>
						  	<input type="text" name="img" id="image1" class="span10"><button onclick="BrowseServer1();" class="btn" type="button">Go!</button>
						</div>  
